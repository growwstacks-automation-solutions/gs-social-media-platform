...
export const CAMPAIGNS_TABLE = 'social_media_content_publishing_database';
export const LOGS_TABLE = 'log_report';
export const CREDENTIALS_TABLE = 'login_credentials';
 ...
 *
 * NOTE: this is a plaintext password compare against the login_credentials table.
